<x-app-layout>
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 max-w-3xl mx-auto md:grid-cols-2 h-24 pl-6 pr-6 pb-4">
                        ...
                        <div class="grid md:mt-0 mt-4 p-4 min_height round_border relative">
                            <div class="grid mt-5">
                                <div>
                                    ...
                                    <h4>Дата регистрации Харгос</h4>
                                    <p><small id="to_hargos"></small></p>
                            ...
                            $("#getInfoForm").submit(function(event) {
                                ...
                                $.post( url, { track_code: track_code } )
                                 .done(function( data ) {
                                     ...
                                     $("#to_hargos").text(data[0].to_hargos);
