...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/hargos-product', [ProductController::class, 'addHargos'])->name('hargos-product');
    ...
    Route::post('/generate-bar-code', [StockController::class, 'generateBarCode'])->name('generate-bar-code');
});
